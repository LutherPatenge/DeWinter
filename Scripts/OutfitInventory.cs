...
public class OutfitInventory : MonoBehaviour {
    ...
    public GameObject personalGridWithElements;
    public GameObject merchantGridWithElements;
    public GameObject outfitInventoryButtonPrefab;
    //public static int selectedPersonalInventoryOutfit;
    //public static int selectedMerchantInventoryOutfit;
    ...
    void Start ()
    {
        ...
        //selectedPersonalInventoryOutfit = -1; // So nothing is selected at the start
        //selectedMerchantInventoryOutfit = -1; // Same
    }
